            ...
            >
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <User className="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-lightText/40 group-focus-within:text-accent transition-colors duration-200" />
                  <input
                    type="text"
                    name="name"
                    value={formData.name}
