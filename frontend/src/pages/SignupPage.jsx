...
const SignupPage = () => {
  ...
  const handleGoogleSignup = async () => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-dark via-mediumDark to-dark relative overflow-hidden pt-12">
      {/* Animated Background Elements with curved dotted line style from the image */}
      <div className="absolute inset-0">
        <div className="absolute top-0 right-0 w-80 h-80 bg-accent/20 rounded-full mix-blend-multiply filter blur-xl animate-pulse-slow"></div>
      ...
      {/* Curved path background element similar to the image */}
      ...
      <div className="relative z-10 min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-4">
        ...
        >
          ...
          <div className="relative">
            {/* Glowing border effect */}            <div className="absolute -inset-1 bg-gradient-to-r from-accent via-blue-500 to-purple-500 rounded-3xl blur opacity-25 group-hover:opacity-75 transition duration-1000"></div>
            
            <div className="relative bg-dark/95 backdrop-blur-xl border border-accent/20 rounded-3xl p-8 shadow-2xl">{/* Header */}
              <motion.div 
