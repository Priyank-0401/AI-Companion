...
const WellnessPage = () => {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-4rem)] max-w-7xl mx-auto p-6 gap-6 relative overflow-hidden">
      {/* Animated Background */}
      ...
      <motion.div
        ...
        className="relative bg-gradient-to-r from-mediumDark/50 to-dark/50 backdrop-blur-xl rounded-3xl border border-mediumDark/30 shadow-2xl p-8"
      >
        ...
        <div className="relative text-center">
          <motion.div 
            className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-accent via-purple-500 to-blue-500 rounded-3xl shadow-xl mb-6"
          ...
          <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-white via-accent to-blue-400 bg-clip-text text-transparent mb-4">
          ...
          {/* Trust Indicators */}
          <div className="flex justify-center items-center gap-6 mt-6 text-lightText/60">
      ...
      <div className="flex-1 grid lg:grid-cols-3 gap-6 overflow-hidden">
        ...
        <div className="space-y-6">
          ...
          <motion.div
            ...
            className="bg-gradient-to-b from-mediumDark/40 to-dark/40 backdrop-blur-xl rounded-2xl border border-mediumDark/30 shadow-2xl p-6"
          >
