...
const ChatWrapper = () => {
  ...
  const handleSend = useCallback(async (messageText) => {
    ...
    try {
      // Call your API to get bot response
      ...
      const botMessage = {
        id: uuid(),
        type: 'bot',
        content: response.message || `I received your message: "${messageText}"\n\nThis is a simulated response. In a real app, this would be generated by the AI.`,
        timestamp: new Date(),
        status: 'delivered'
      };
      ...
      // Save or update conversation in history
      saveChatToHistory([...messages, userMessage, botMessage]);
  ...
  return (
    <div className="flex-1 flex flex-col h-full min-h-0 bg-[#222831] overflow-hidden">
      <div className="flex-1 flex flex-col h-full w-full min-h-0 bg-[#222831]">
        {/* Messages Area */}
        <div 
        ...
        {/* Input Area - Ensure background color extends to bottom */}
        <div className="w-full border-t border-gray-700/50 bg-[#1E1F2B] py-4 mb-0">
          <div className="flex justify-center w-full bg-[#1E1F2B]">
