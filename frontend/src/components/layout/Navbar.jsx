              ...
              {!loading && (
                user ? (
                  ...
                  <div className="flex items-center space-x-2">
                    <Link
                      to="/login"
                      className="px-4 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-200 hover:text-indigo-600 dark:hover:text-indigo-400 rounded-lg transition-colors"
                    >
                      Log in
                    </Link>
                    <Link
                      to="/signup"
                      className="px-4 py-2.5 text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 rounded-lg transition-colors flex items-center"
                    >
